...
const CreateWebCommerce = ({ commerceToken, cif }) => {
  ...
  const handleCreate = async (event) => {
    ...
    const response = await fetch(`http://localhost:3000/api/webCommerce/create`, {
      method: "POST",
      headers: {
  ...
  return (
    <form onSubmit={handleCreate} className="space-y-6 bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-3xl font-bold mb-6 text-gray-900">Crear WebCommerce</h2>
      <div>
...
export default CreateWebCommerce;